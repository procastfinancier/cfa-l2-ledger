...
A personal revision tool: 56 topics across 10 subjects, filled in with my own
...
The page is read-only apart from the search box; all content lives in the data
structures at the bottom of `index.html` (`CONTENT`, `GAPS`, `TUITION_MISSES`,
`STATUS`, `LINKS`).
